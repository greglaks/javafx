...
//			 labelBox.getStyleClass().add("topcontainer");
	...
	public SendingTab(String caption){
	...
	private void createContents() {
		...
		ColumnConstraints c1 = new ColumnConstraints(90, Control.USE_COMPUTED_SIZE, Double.MAX_VALUE);
		c1.setHgrow(Priority.ALWAYS);
		c1.setPercentWidth(10);

		ColumnConstraints c2 = new ColumnConstraints(90, Control.USE_COMPUTED_SIZE, Double.MAX_VALUE);
		c2.setHgrow(Priority.ALWAYS);
		c2.setPercentWidth(10);
		
		ColumnConstraints c3 = new ColumnConstraints(0, Control.USE_COMPUTED_SIZE, Double.MAX_VALUE);
		c3.setHgrow(Priority.ALWAYS);
		c3.setPercentWidth(40);
		
		ColumnConstraints c4 = new ColumnConstraints(0, Control.USE_COMPUTED_SIZE, Double.MAX_VALUE);
